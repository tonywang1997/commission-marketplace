...
class PortfoliosTest < ApplicationSystemTestCase
  ...
  test "creating a Portfolio" do
    ...
    fill_in "Create", with: @portfolio.create
    fill_in "Destroy", with: @portfolio.destroy
    fill_in "Edit", with: @portfolio.edit
    fill_in "New", with: @portfolio.new
    fill_in "Update", with: @portfolio.update
